package site.mufen.test.domain.tag;
...
import site.mufen.domain.tag.service.ITagService;
...
/**
 * @author mufen
 * @Description tagService 单测
 * @create 2025/1/8 16:48
 */
@Slf4j
@SpringBootTest
...
public class ITagServiceTest {
    ...
    public void test_get_tag_bitmap() {
        ...
        // 是否存在
        log.info("mufen 存在，预期结果为 true，测试结果:{}", bitSet.get(redisService.getIndexFromUserId("mufen")));
        log.info("WangPan 存在，预期结果为 true，测试结果:{}", bitSet.get(redisService.getIndexFromUserId("WangPan")));
